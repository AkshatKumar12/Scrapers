...
func scrapeClientRequests(searchURL string, proxyString interface{}) (*http.Response, error) { // prxoy string is kept as a nil in our program
	baseClient := getScrapeClient(proxyString) // if proxyString is available then use it else use default
